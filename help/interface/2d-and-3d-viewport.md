...
* <b>Malha</b>: selecione outra malha para mostrar seus ativos de material ou ver nuances de ativos de luz ambiente.
...
* <b>Luz</b>: selecione e ajuste uma luz ambiente, incluindo configurações como ativar sombras e o plano do solo.
...
A <b>exibição 2D</b> é bidimensional, portanto não há opção de órbita. Clicar com o botão direito + Alt + arrastar aumentará e diminuirá o zoom, enquanto que clicar com o botão do meio + Alt + arrastar aumentará.

Na <b>exibição 3D </b>e na <b>exibição 2D</b>, use o <b>F</b> para focalizar no ativo. Isso é útil se você perder de vista o ativo 3D ou o espaço 2D.
...
Para abrir a <b>exibição 2D</b>, use o <b>botão Exibir seleção </b>no canto superior direito da viewport. Você também pode usar o atalho <b>2</b> para alternar rapidamente para a <b>exibição 2D</b>.

Com a <b>exibição 2D </b>aberta, algumas novas opções aparecem:

* No canto superior direito da **exibição 2D**, use o menu suspenso para alterar a origem dos canais disponíveis para exibição.
...
* Na parte inferior da **exibição 2D**, você pode:
