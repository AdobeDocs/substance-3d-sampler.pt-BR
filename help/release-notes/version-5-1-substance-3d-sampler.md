...
Aumente o desempenho e reduza o tempo de computação com a camada Nivelar transformando os resultados de camadas empilhadas em um único conjunto de mapas em uma camada unificada. Renomeie-os e duplique-os para mais eficiência!
...
Com os filtros aprimorados Equalizar e Carimbo, além de um novo recurso de remoção automática de dobras para tecidos, você pode obter digitalizações perfeitas com apenas alguns cliques, não importa a complexidade do material.
...
* [Exibição 2D] O tamanho do pincel agora se adapta à resolução de textura atual
* [Exibição 3D] Alternar a escala de exibição nativa para renderização 3D nas preferências
...
* [Filtros] Novos recursos no filtro Carimbo
...
* [Desempenho] Melhorar o uso de memória para a Visualização 3D
...
* [UI] Aviso sobre a obsolescência da criação de luz ambiente

## Corrigido:

* [2D View] Selecionar “display with physical ratio” pode não funcionar ao usar filtros Substance
* [captura 3D] Os arquivos Svg estão listados no seletor de arquivos, mas não são compatíveis
* [Exibição 3D] O parâmetro de intensidade de emissão nas Configurações do sombreador não funciona
* [Exibição 3D] Às vezes, a posição da malha é incorreta ao criar um novo ativo
* [Exibição 3D] Alternar para o rastreamento de caminho trava falhas em hardware não compatível
...
* [Filtros] A visualização do pincel ao usar o filtro Carimbo pode estar incorreta, dependendo da textura e dos tamanhos do pincel
...
* [UI] O parâmetro V da divisão em textura está parcialmente oculto nas Configurações do visualizador e na Exibição 3D
