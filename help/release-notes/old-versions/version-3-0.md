...
breadcrumb-title: ''
description: Revise as notas de versão do Substance 3D Sampler versão 3.0 para saber mais sobre retrabalho de interface, luzes ambiente, filtros e integração de Creative Cloud.
...
O **Substance 3D Sampler 3.0.0** é o novo nome do Substance Alchemist agora que ele está conectado ao Adobe Creative Cloud. Ele traz um retrabalho de interface completo, suporte para a criação de luzes ambiente, filtros totalmente reformulados e novos, funcionalidade Enviar para e suporte a sombreador ASM.
...
### Criação de nova luz ambiente

![](../../assets/idl.jpg){width="600px"}

O Sampler agora permite fazer mais do que apenas materiais. As Luzes de Ambiente são um novo tipo de ativo com seu [próprio conjunto de filtros](../../filters/hdri-tools/hdri-tools.md). Inicie a partir de [fotos com 360 colchetes](../../filters/hdri-tools/hdr-merge.md), crie uma luz ambiente [do zero](../../filters/hdri-tools/shape-light.md) ou [edite um arquivo HDR existente](../../filters/hdri-tools/nadir-patch.md).
...
* [Transformação de distorção](../../filters/tools/warp-transform.md)
...
* Suporte a texturas não quadradas
...
* [UI] Nova barra de ferramentas para acessar diretamente filtros específicos (Cortar, Transformar, Transformação de perspectiva, Carimbo)
...
* [UI] Atalho - use “2” para alternar a visibilidade da exibição 2D
...
* [Painel do projeto] Crie um ativo (luz material ou ambiente) usando o ícone +
...
* [Luz ambiente] Criar luz ambiente no Substance 3D Sampler
* [Luz ambiente] Ao criar uma luz ambiente, arrastar e soltar imagens exibirá a janela Modelo de criação de luz ambiente
* [Luz ambiente] No Modelo de criação de luz ambiente, selecione Importação de ambiente para atribuir sua imagem ao ambiente na visualização 3D
* [Luz ambiente] No Modelo de criação de luz ambiente, selecione Mesclar HDR para criar uma luz ambiente de várias imagens de 360 graus com diferentes exposições
* [Luz ambiente] No Modelo de criação de luz ambiente, selecione “Usar como bitmap” para editar a(s) imagem(ns) antes de criar uma luz ambiente
* [Luz ambiente] Atribuir o uso do ambiente na camada de importação de imagem para atribuir diretamente a imagem ao ambiente na visualização 3D
* [Luz ambiente] Na exibição 2D do canal de ambiente, há uma correção de cores automática para que a renderização apareça da mesma forma que na exibição 3D
* [Luz ambiente] Novo conteúdo dedicado para a criação de luz ambiente
...
* [Exportar] Enviar materiais e iluminação ambiente para o Adobe Substance 3D Painter
* [Exportar] Enviar luzes ambiente para o Adobe Substance 3D Stager
...
* [Renderização] Adição de suporte a Revestimento (Cor de revestimento, Aspereza do revestimento, Normal de revestimento, Specular level de revestimento e IOR de revestimento)
...
* [Renderização] O renderizador Realtime Engine (2021) apresenta uma nova maneira de calcular sombras a partir da luz ambiente
* [Renderização] O renderizador Realtime Engine (2021) calcula em tempo real a irradiância da luz do ambiente
* [Painel Configurações do sombreador] Novo painel Configurações do sombreador para ajustar parâmetros de sombreador de material específicos
* [Painel de configurações do sombreador] Novos parâmetros (Escala normal, Escala do height, Nível do height, Intensidade de emissão, IOR, Intensidade normal do revestimento e IOR do revestimento)
* [Painel de configurações do sombreador] Parâmetros específicos para o Mecanismo em tempo real 2021 (Dispersão da subsuperfície, Distância de dispersão, Red Shift e Dispersão de Rayleigh)
* [Painel Configurações do sombreador] Os valores de configuração são salvos por ativo
* [Painel de configurações do visualizador] Adicionada uma visualização das luzes de ambiente padrão
...
* [Content] Novas luzes de ambiente padrão
...
* [Content] Novo filtro de transformação de distorção
...
* [Content] Lado a lado - opção para pintar as costuras cortadas para uma divisão perfeita
...
* [Widgets] Os widgets Transformar e Posições podem desaparecer. Oculte e reexiba a camada para fazê-las aparecer.
* [Exportar] A exportação SBSAR de uma luz ambiente perde a precisão 32profundidade de bits
