---
helpx_url: "https://helpx.adobe.com/br/substance-3d-sampler/release-notes/old-versions/version-2020-2-2-2.html"
breadcrumb-title: ''
...
Nesta versão, agora é possível tinta e editar máscaras de filtros diretamente no Visualização 2D sem precisar importar uma imagem externa. A pintura automaticamente azuleia-se para possibilitar a criação de material perfeito.

![](../../assets/2d-paint-demo-optim.gif){width="450px"}

* **Entrando no Modo de Tinta 2D**\
  Para iniciar o modo de Tinta 2D, basta clicar no ícone de pincel ao lado do nome da máscara nas propriedades do filtro.

  ![](../../assets/brush-icon-1.png)
* **Barra de Ferramentas de Tinta 2D**\
  Quando estiver no modo de tinta, a Visualização 2D exibirá uma nova barra de ferramentas na parte superior com as seguintes funcionalidades:
  ...
  * **Parar desenho**: saia do modo de Tinta 2D.

  ![](../../assets/brush-toolbar.png)
* **Atalhos de teclado**\
  O modo de tinta oferece suporte aos seguintes atalhos para acelerar o processo de pintura:
...
* **Novos Filtros**\
  ...
  * Validação do PBR
* **Novo Modo Combinar**
* Os filtros e outras ferramentas agora suportam um novo modo de mesclagem chamado **Modo de Combinar Por Canal**. Quando esse modo está ativado, é possível ajustar a operação de mesclagem de cada canal no painel de propriedades.
