...
As ferramentas são o maior conjunto de filtros no Sampler, por isso pode ser difícil entender o que as diferencia. A maneira mais fácil de entender os filtros de ferramenta é que eles são usados para corrigir problemas técnicos com materiais.
...
* [Height para normal](height-to-normal.md)
* [Imagem para material](image-to-material.md)
* [Torná-lo lado a lado](make-it-tile.md)
