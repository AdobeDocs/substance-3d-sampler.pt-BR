...
* **Deslocamento de Posição**: -1 para 1\
  Desloca a transformação da posição inicial nos eixos horizontal e vertical.
...
* **Transformação**:\
  Ajuste a transformação das alças com controles deslizantes em vez de na **exibição 2D**.
  * **Escala em X**: 0-2
  * **Inclinar verticalmente**: -7,44 para 2
  * **Inclinar horizontalmente**: 0-1
  * **Escala em Y**: 0 - 13,15
* **Desativar transformação por canal**: alternar\
  Quando ativada, serão exibidos controles adicionais que permitem desativar essa transformação para cada canal.

## Guia de Uso

Clique na **ferramenta Transformar** para adicionar uma nova camada de filtro Transformar ao topo da pilha de camadas.

Criar ou selecionar uma camada de filtro Transformar abre automaticamente a **exibição 2D**. Com a camada Transformar selecionada, uma **Barra de ferramentas** aparece na parte superior da **exibição 2D**.
