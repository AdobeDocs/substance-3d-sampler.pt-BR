...
* **Usar máscara**: alternar\
  ...
  * **Máscara**: imagem/pincel\
    Importe uma imagem para usar como máscara ou use o pincel para pintar uma máscara diretamente na **exibição 2D**
...
* **Detectar bordas**: alternar\
  ...
  * **Usar cor base**: alternar\
    Alternar se as informações de cor base são consideradas na geração de costura
...
* **Transformar**: 0-2\
  Ajuste os valores de transformação da matriz. Aumente os valores de X e W para ajustar a quantidade de sobreposição entre o material subjacente e o material sobreposto.
* **Deslocamento**: 0-1\
...
1. Adicionar o **filtro de divisão** ao topo da pilha de camadas
...
Para alguns materiais, o uso do **filtro de divisão em blocos gráficos** sozinho ainda resultará em artefatos ou problemas ao longo da linha de junção. Nesse caso, é uma boa ideia usar outros filtros, como **Carimbo**, para corrigir problemas de junção e divisão em blocos gráficos.
