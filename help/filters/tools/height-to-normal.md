...
breadcrumb-title: ''
description: Use a ferramenta Height para normal no Substance 3D Sampler para converter mapas de altura em mapas normais para fluxos de trabalho de criação de material.
...
Na imagem acima, não há dados normais do material. Apenas o mapa de altura está disponível e é mostrado no **Visualização 2D**.

![](../../assets/h2n-out.jpg)

Com o **filtro Height para Normal**, os dados normais são gerados a partir do mapa de altura mostrado na imagem superior. A luz reflete de forma mais realista no material da segunda imagem graças ao mapa normal gerado.
...
* **Usar unidades mundiais**: alternar\
  ...
  * **Se a opção Usar unidades mundiais estiver habilitada:**
    ...
    * **Profundidade do Height (cm)**: 0-10\
      Defina a distância representada pelo mapa de altura. Se o mapa de altura representar uma pequena distância, uma grande diferença nos valores do mapa de altura poderá ter um pequeno impacto no ângulo normal. Se o mapa de altura representar uma grande distância, uma pequena diferença nos valores do mapa de altura poderá representar um grande ângulo no mapa normal.
