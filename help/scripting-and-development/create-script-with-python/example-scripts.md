---
helpx_url: "https://helpx.adobe.com/br/substance-3d-sampler/scripting-and-development/create-a-script-with-python/example-scripts.html"
breadcrumb-title: ''
description: Acesse scripts de exemplo em Python para o Substance 3D Sampler para saber como usar a API e automatizar os fluxos de trabalho de criação de material.
helpx_creative_field: ""
helpx_description: Sampler > Scripting and Development > Create a Script with Python > Example Scripts
helpx_experience_level: ""
helpx_learn_topic: ""
helpx_tags: ""
title: Exemplos de scripts
...
Os scripts abaixo podem ser usados para entender como a API do Sampler funciona. Use e adicione a esses scripts conforme necessário para o fluxo de trabalho.

## Exportar tudo

Exportar material com várias predefinições de exportação.
...
## Importar metadados de um arquivo CSV

Este script importa e cria metadados personalizados de um arquivo csv: [material\_physical\_property\_clo.csv](https://helpx.adobe.com/content/dam/help/en/substance-3d/documentation/sadoc/files/234455545/255426646/1/1680276968224/material-physical-property-clo.csv)
